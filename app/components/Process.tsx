...
const Process = () => {
  ...
  return (
    <section id="proceso" className="relative min-h-screen flex items-center pt-32 pb-16 md:pt-32 md:pb-24 lg:pt-40 lg:pb-32 xl:pt-48 xl:pb-40 px-6 bg-gray-100">
